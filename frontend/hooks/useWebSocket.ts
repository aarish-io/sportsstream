...
import { WS_BASE_URL, INITIAL_RECONNECT_DELAY, MAX_RECONNECT_DELAY } from '../constants.ts';
import { ConnectionStatus, WSMessage } from '../types.ts';
...
export const useWebSocket = (
  ...
  const initConnection = useCallback(() => {
    // Do not open a second socket while one is active/connecting.
