  ...
  return (
    <div className="min-h-screen p-4 md:p-8 font-sans sportsstream-grid-fade">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Header Section */}
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-gradient-to-r from-brand-yellow to-amber-200 border-2 border-black rounded-2xl p-6 shadow-hard">
          <div>
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full border border-black bg-white text-[11px] font-bold uppercase tracking-[0.18em] mb-3">
              Live Sports Studio
            </div>
            <h1 className="text-3xl md:text-4xl font-black tracking-tight text-brand-dark mb-1">
              SportsStream
            </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <main className="lg:col-span-2 space-y-6">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-mono bg-black text-white px-2 py-1 rounded-full border border-black shadow-hard-sm">
