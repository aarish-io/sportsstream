...
export const LiveFeed: React.FC<LiveFeedProps> = ({ messages, isActive, isLoading }) => {
  if (!isActive) {
    return (
      <div className="h-full flex flex-col items-center justify-center text-center p-8 bg-white/90 border-2 border-black rounded-2xl border-dashed shadow-hard-sm">
  ...
  return (
    <div className="flex flex-col h-full bg-white border-2 border-black rounded-2xl overflow-hidden shadow-hard">
      <div className="p-4 bg-gradient-to-r from-brand-blue to-cyan-100 border-b-2 border-black flex justify-between items-center">
              ...
              <div key={msg.id} className="animate-in fade-in slide-in-from-top-2 duration-300">
                <div className="flex gap-3">
                  ...
                  <div className="pb-4">
                    ...
                    <p className="text-sm font-medium text-gray-800 leading-relaxed bg-white p-3 rounded-xl rounded-tl-none border-2 border-gray-100 shadow-[0_4px_0_0_rgba(24,24,27,0.07)]">
                      {msg.message}
                    </p>
                    {metadataLabel && (
